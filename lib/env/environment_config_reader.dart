import 'package:expense_tracker/core/models/localized_name_model/localized_name_model.dart';
...
class FlutterEnvironmentConfigReader implements IEnvironmentConfigReader {
  ...
  LocalizedNameModel getAppLocalizedName() => LocalizedNameModel.fromJson({"ar": getAppNameAr(), "en": getAppNameEN()});
