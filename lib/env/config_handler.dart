...
class AppNameHandler {
  ...
  Future<void> _handleIOS() async {
    await reWriteFile(path: 'ios/en.lproj/InfoPlist.strings', content: _infoPlistFileContent(enName));
    await reWriteFile(path: 'ios/ar.lproj/InfoPlist.strings', content: _infoPlistFileContent(arName));
  }
