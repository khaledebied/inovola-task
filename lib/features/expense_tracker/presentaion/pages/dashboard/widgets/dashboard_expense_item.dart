...
import 'package:expense_tracker/features/expense_tracker/presentaion/pages/dashboard/utils/expense_category_helper.dart';
...
class DashboardExpenseItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categoryColor = ExpenseCategoryHelper.getCategoryColor(expense.category);
