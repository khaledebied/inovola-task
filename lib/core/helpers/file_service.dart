...
import 'package:expense_tracker/core/errors/custom_error.dart';
...
class AppFileService {
  ...
  Future<List<File>?> pickFile(
    ...
    bool canAccess = await GetIt.I<PermissionServices>().requestPermission(Permission.storage, context);
