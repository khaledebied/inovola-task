import 'package:expense_tracker/core/constants/types.dart';
    ...
    return BlocBuilder<BaseBloc<T>, BaseState<T>>(
      ...
      builder: (_, state) {
        return state.maybeWhen(
          ...
          failure: (error, callback) => onFailedWidget?.call(context, error, callback) ?? ShowErrorWidget(error: error, callback: callback),
        );
      },
    );
  }
