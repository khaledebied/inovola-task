...
import 'package:expense_tracker/core/http/models/request_body_model.dart';
...
class AuthInterceptor extends Interceptor {
  ...
  Future<bool> _retry(
    ...
    try {
      ...
      final cloneReq =
          await dio.request(dioException.requestOptions.path, options: opts, data: dioException.requestOptions.data, queryParameters: dioException.requestOptions.queryParameters);
