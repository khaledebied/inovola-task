...
import 'package:expense_tracker/core/requester/state/requester_state.dart';
...
class RequesterConsumer<T> extends StatelessWidget {
  ...
  final Widget Function(BuildContext context, BaseError error, VoidCallback callback) failureBuilder;
  final Widget Function(BuildContext context) loadingBuilder;

  const RequesterConsumer({super.key, required this.requester, required this.successBuilder, required this.failureBuilder, required this.loadingBuilder, this.listener});
