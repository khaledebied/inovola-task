...
class OptionController<T> extends Cubit<OptionControllerState<T>> {
  ...
  OptionController({T? defaultValue}) : super(OptionControllerState(selectedValue: defaultValue, tempValue: defaultValue));
...
class OptionControllerState<T> {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is OptionControllerState && runtimeType == other.runtimeType && selectedValue == other.selectedValue && tempValue == other.tempValue;
