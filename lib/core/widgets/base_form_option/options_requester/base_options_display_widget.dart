...
import 'package:expense_tracker/core/widgets/app_text_span_with_seperator.dart';
import 'package:expense_tracker/core/widgets/base_form_option/options_listview/option_item_widget.dart';
...
class BaseOptionsDisplayWidget<T> extends StatelessWidget {
  ...
  Widget getSingleOptionItem({required T option, required BuildContext context, String? suffixText}) {
