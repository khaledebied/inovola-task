...
import 'package:expense_tracker/core/widgets/bottom_sheet_views/bottom_sheet_button_widget.dart';
import 'package:expense_tracker/core/widgets/search_form_field/search_form_field.dart';
                    ...
                    Expanded(
                      child: IgnorePointer(
                        ...
                        child: Container(
                          ...
                          margin: widget.contentPadding ?? const EdgeInsets.symmetric(vertical: 20, horizontal: 24),
                          child: BlocBuilder(
...
extension MediaQueryExtension on BuildContext {
  ...
  double get bodyHeight => MediaQuery.of(this).size.height - MediaQuery.of(this).viewPadding.top - MediaQuery.of(this).viewInsets.top;
