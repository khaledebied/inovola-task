...
import 'package:expense_tracker/core/widgets/base_form_option/options_listview/selectable_option_item_widget.dart';
      ...
      itemBuilder: (context, index) {
        if (index == itemCount - 1 && isLoading) {
          return Row(
            ...
            children: [
              itemCount > 1 ? const AppLoaderWidget.smallProgress() : const AppLoaderWidget.largeLogo(),
            ],
          );
        }
