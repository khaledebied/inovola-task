    ...
    return AnimatedContainer(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            filled: true,
            hintStyle: TextStyle(fontSize: 12.sp, color: const Color.fromRGBO(151, 151, 151, 1), fontWeight: FontWeight.w400),
            prefixIcon: InkWell(
              onTap: () {
            ...
            border: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(99)), borderSide: BorderSide.none)),
      ),
    );
  }
}
